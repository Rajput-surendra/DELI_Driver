final String appName = 'DELI DeliveryBoy';

// final String baseUrl = 'https://alphawizztest.tk/Maangos_Ecom/delivery_boy/app/v1/api/';
final String baseUrl =   'https://lifegracious.com/app-admin/delivery_boy/app/v1/api/';
